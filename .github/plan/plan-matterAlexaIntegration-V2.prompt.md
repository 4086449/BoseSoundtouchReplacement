...
### ~~Bug 8: Matter Bridge flow not in flows.json~~ ✗ Done
...
## ~~Phase 5: Commission via Dashboard Helper~~ ✗ Done
...
## ~~Phase 5.5: Build Dashboard Commissioning Helper (nodered/data/flows.json)~~ ✗ Done
